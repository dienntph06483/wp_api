            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" action="javascript:void(0)" id="frmEditPost" method="post">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" action="javascript:void(0)" id="frmCreateNewWpPost">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="content" id="content" placeholder="Enter description haha 3 demo 1 1"></textarea>
                                </div>
                            </div>
                            <div class="form-group"> 
                                <div class="col-sm-offset-2 col-sm-10">
